...
build_time_vars = {'ABIFLAGS': '',
 ...
 'CONFIG_ARGS': "'-C' '--enable-framework' '--enable-universalsdk=/' "
                "'--with-universal-archs=intel-64' '--with-computed-gotos' "
                "'--without-ensurepip' "
                "'--with-openssl=/tmp/_py/libraries/usr/local' "
                "'--with-tcltk-includes=-I/tmp/_py/libraries/usr/local/include' "
                "'--with-tcltk-libs=-ltcl8.6 -ltk8.6' 'LDFLAGS=-g' 'CFLAGS=-g' "
                "'CC=gcc'",
 ...
 'CPPFLAGS': '-IObjects -IInclude -IPython -I. '
             '-I/Users/sysadmin/build/v3.9.5/Include',
 'CXX': 'g++',
 'DESTDIRS': '/Library/Frameworks/Python.framework/Versions/3.9 '
             '/Library/Frameworks/Python.framework/Versions/3.9/lib '
             '/Library/Frameworks/Python.framework/Versions/3.9/lib/python3.9 '
             '/Library/Frameworks/Python.framework/Versions/3.9/lib/python3.9/lib-dynload',
 'DESTLIB': '/Library/Frameworks/Python.framework/Versions/3.9/lib/python3.9',
 'DESTPATH': '',
 'DESTSHARED': '/Library/Frameworks/Python.framework/Versions/3.9/lib/python3.9/lib-dynload',
 'DFLAGS': '',
 'DIRMODE': 755,
 ...
 'INCLDIRSTOMAKE': '/Library/Frameworks/Python.framework/Versions/3.9/include '
                   ...
                   '/Library/Frameworks/Python.framework/Versions/3.9/include/python3.9',
 'INCLUDEDIR': '/Library/Frameworks/Python.framework/Versions/3.9/include',
 'INCLUDEPY': '/Library/Frameworks/Python.framework/Versions/3.9/include/python3.9',
 ...
 'LDVERSION': '3.9',
 'LIBC': '',
 'LIBDEST': '/Library/Frameworks/Python.framework/Versions/3.9/lib/python3.9',
 'LIBDIR': '/Library/Frameworks/Python.framework/Versions/3.9/lib',
 'LIBFFI_INCLUDEDIR': '',
 'LIBM': '',
 'LIBOBJDIR': 'Python/',
 'LIBOBJS': '',
 'LIBPC': '/Library/Frameworks/Python.framework/Versions/3.9/lib/pkgconfig',
 'LIBPL': '/Library/Frameworks/Python.framework/Versions/3.9/lib/python3.9/config-3.9-darwin',
 'LIBPYTHON': '',
 ...
 'MACHDEP': 'darwin',
 'MACHDEP_OBJS': '',
 'MACHDESTLIB': '/Library/Frameworks/Python.framework/Versions/3.9/lib/python3.9',
 'MACOSX_DEPLOYMENT_TARGET': '10.9',
 'MAINCC': 'gcc',
 'MAJOR_IN_MKDEV': 0,
 'MAJOR_IN_SYSMACROS': 0,
 'MAKESETUP': '/Users/sysadmin/build/v3.9.5/Modules/makesetup',
 'MANDIR': '/Library/Frameworks/Python.framework/Versions/3.9/share/man',
 'MKDIR_P': '/Users/sysadmin/build/v3.9.5/install-sh -c -d',
 ...
 'PY_BUILTIN_MODULE_CFLAGS': '-Wno-unused-result -Wsign-compare '
                             ...
                             '-g -fwrapv -O3 -Wall -arch x86_64 -g -std=c99 '
                             '-Wextra -Wno-unused-result -Wno-unused-parameter '
                             '-Wno-missing-field-initializers '
                             '-Wstrict-prototypes '
                             '-Werror=implicit-function-declaration '
                             '-fvisibility=hidden  '
                             '-I/Users/sysadmin/build/v3.9.5/Include/internal '
                             '-IObjects -IInclude -IPython -I. '
                             '-I/Users/sysadmin/build/v3.9.5/Include '
                             '-DPy_BUILD_CORE_BUILTIN',
 'PY_CFLAGS': '-Wno-unused-result -Wsign-compare -Wunreachable-code '
              '-fno-common -dynamic -DNDEBUG -g -fwrapv -O3 -Wall -arch x86_64 '
              '-g',
 ...
 'PY_CORE_CFLAGS': '-Wno-unused-result -Wsign-compare -Wunreachable-code '
                   ...
                   'x86_64 -g -std=c99 -Wextra -Wno-unused-result '
                   '-Wno-unused-parameter -Wno-missing-field-initializers '
                   '-Wstrict-prototypes -Werror=implicit-function-declaration '
                   '-fvisibility=hidden  '
                   '-I/Users/sysadmin/build/v3.9.5/Include/internal -IObjects '
                   '-IInclude -IPython -I. '
                   '-I/Users/sysadmin/build/v3.9.5/Include -DPy_BUILD_CORE',
 ...
 'PY_STDMODULE_CFLAGS': '-Wno-unused-result -Wsign-compare -Wunreachable-code '
                        ...
                        '-arch x86_64 -g -std=c99 -Wextra -Wno-unused-result '
                        '-Wno-unused-parameter -Wno-missing-field-initializers '
                        '-Wstrict-prototypes '
                        '-Werror=implicit-function-declaration '
                        '-fvisibility=hidden  '
 ...
 'SCRIPTDIR': '/Library/Frameworks/Python.framework/Versions/3.9/lib',
 'SETPGRP_HAVE_ARG': 0,
 'SGI_ABI': '@SGI_ABI@',
 'SHELL': '/bin/sh',
 ...
 'SRC_GDB_HOOKS': '/Users/sysadmin/build/v3.9.5/Tools/gdb/libpython.py',
 'STDC_HEADERS': 1,
 ...
 'TESTRUNNER': 'DYLD_FRAMEWORK_PATH=/private/tmp/_py/_bld/python ./python.exe '
               '/Users/sysadmin/build/v3.9.5/Tools/scripts/run_tests.py',
 'TESTTIMEOUT': 1200,
 'TIMEMODULE_LIB': 0,
 ...
 'UNIVERSALSDK': '/',
 'UPDATE_FILE': 'python3 '
                '/Users/sysadmin/build/v3.9.5/Tools/scripts/update_file.py',
 'USE_COMPUTED_GOTOS': 1,
 'VERSION': '3.9',
 'VPATH': '/Users/sysadmin/build/v3.9.5',
 'WINDOW_HAS_FLAGS': 1,
 ...
 'abs_srcdir': '/Users/sysadmin/build/v3.9.5',
 'datarootdir': '/Library/Frameworks/Python.framework/Versions/3.9/share',
 'exec_prefix': '/Library/Frameworks/Python.framework/Versions/3.9',
 'prefix': '/Library/Frameworks/Python.framework/Versions/3.9',
 'srcdir': '/Users/sysadmin/build/v3.9.5'}
