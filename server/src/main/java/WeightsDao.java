...
public class WeightsDao {
    ...
    public void createWeightsEntry(Integer[] weights_entry) {
        ...
        try {
            ...
            preparedStatement = conn.prepareStatement("INSERT INTO Conv1 (conv1)  VALUES (?)");
            Integer user_id = 1;
            Integer conv1 = 1;
            ...
            conn = dataSource.getConnection();
            preparedStatement = conn.prepareStatement("INSERT INTO Conv2 (conv2)  VALUES (?)");
            Integer conv2 = 1;
            ...
            conn = dataSource.getConnection();
            preparedStatement = conn.prepareStatement("INSERT INTO FC3 (fc3)  VALUES (?)");
            Integer fc3 = 1;
            ...
            conn = dataSource.getConnection();
            preparedStatement = conn.prepareStatement("INSERT INTO FC4 (fc4)  VALUES (?)");
            Integer fc4 = 1;
            ...
            conn = dataSource.getConnection();
            preparedStatement = conn.prepareStatement("INSERT INTO Softmax (softmax)  VALUES (?)");
            Integer smax = 1;
